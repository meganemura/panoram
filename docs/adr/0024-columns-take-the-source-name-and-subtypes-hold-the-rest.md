...
spacequery names a column after its source field and keeps that source's values.
...
A column that spacequery computes uses a spacequery name.
...
spacequery does not unify values across sources.
